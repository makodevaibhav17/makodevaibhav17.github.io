...
/* harmony import */ var _addemployee_addemployee_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./addemployee/addemployee.component */ "./src/app/addemployee/addemployee.component.ts");
...
const routes = [
    ...
    {
        path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
    },
    {
        path: 'empDetails/:eid', component: _employee_details_employee_details_component__WEBPACK_IMPORTED_MODULE_1__["EmployeeDetailsComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
    },
    {
        path: 'addemp', component: _addemployee_addemployee_component__WEBPACK_IMPORTED_MODULE_7__["AddemployeeComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
    },
    {
...
/* harmony import */ var _update_emp_update_emp_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./update-emp/update-emp.component */ "./src/app/update-emp/update-emp.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            ...
            _update_emp_update_emp_component__WEBPACK_IMPORTED_MODULE_15__["UpdateEmpComponent"],
...
let EmployeeDetailsComponent = class EmployeeDetailsComponent {
    ...
    GetDataFromUrl() {
        this.route.paramMap
            .subscribe((param) => {
            this.eid = +param.get("eid");
        });
    }
    GetDataFromBackend() {
        this.service.getEmployeeByEid(this.eid)
            .subscribe((response) => {
            //console.log(response)
...
let HomeComponent = class HomeComponent {
        ...
        if (this.onRadioCheck()) {
            ...
            this.dialogservice.OpenConfirmDialog('Are you sure to delete this record?')
                ...
                if (res) {
                    //delete the record
                    // console.log('====>>> '+res)
                    this.service.DeleteEmp(this.empobj.eid)
                        .subscribe((response) => {
                        console.log(response);
    ...
    OnChangeStatus() {
        if (this.onRadioCheck()) {
            this.dialogservice.OpenConfirmDialog('Are you sure to change status ?')
                .afterClosed()
                .subscribe((res) => {
                if (res) {
                    if (this.empobj.status.toLocaleLowerCase() == 'suspend') {
                        this.toaster.warning('this Employee is Suspend You Can Not Change Status ' + this.empobj.eid);
                    }
                    else {
                        this.service.changeStatus(this.empobj.eid)
                            .subscribe((response) => {
                            console.log(response);
                            this.toaster.success(response);
                            this.GetEmpData();
...
let HttpService = class HttpService {
    ...
    getEmployeeByEid(eid) {
        return (this.http.get(`${this.baseUrl}getemployeebyeid/${eid}`));
    }
    getAllCountry() {
    ...
    DeleteEmp(eid) {
        return (this.http.delete(`${this.baseUrl}deleteEmployee/${eid}`, { responseType: 'text' }));
    }
    changeStatus(eid) {
        return (this.http.get(`${this.baseUrl}changeStatus/${eid}`, { responseType: 'text' }));
    }
};
...
module.exports = __webpack_require__(/*! D:\Front End 1\Angular\my-project\src\main.ts */"./src/main.ts");
